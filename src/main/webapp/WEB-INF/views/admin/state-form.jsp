...
<head>
    ...
    <title>
        ${empty state.id ? 'Add State' : 'Edit State'} - SmartHouse
    </title>
            ...
            <div class="col-lg-7">
                ...
                <div class="text-center mb-5">
                    ...
                    <p class="text-muted">
                        ...
                        ${empty state.id
                            ? 'Add a state to begin building the location hierarchy.'
                            : 'Update the selected state information.'}
